...
print_info "Installing dependencies for Debian..."
...
if ! check_command rg; then
    ...
    # Debian may need to install from GitHub releases
    if apt-cache show ripgrep &> /dev/null; then
        ...
        curl -Lo ripgrep.deb "https://github.com/BurntSushi/ripgrep/releases/latest/download/ripgrep_${RG_VERSION#v}_amd64.deb"
...
if ! check_command fd; then
    ...
    # Create symlink since Debian calls it fdfind
